...
<<<<<<<< HEAD:docs/site_libs/datatables-binding-0.31/datatables.js
        $(td).find('input').first().val(v).trigger('input');
        searchColumn(i, v);
|||||||| parent of dd05f02 (Update website):docs/site_libs/datatables-binding-0.28/datatables.js
...
>>>>>>>> dd05f02 (Update website):docs/site_libs/datatables-binding-0.32/datatables.js
      });
      table.draw();
    }
