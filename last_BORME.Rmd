...
media_alt_txt <- paste("Gráfico alluvial con los anuncios publicados hoy.",
                       "Hay dos columnas de las categorías sección y emisor, ordenado por frequencia.",
                       "Hoy hay", length(unique(freqs$section_number)), 
                       "secciones y", length(unique(freqs$emisor)), "emisores")
