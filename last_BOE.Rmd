...
Aquí está la tabla completa con section, epígrafe, número de páginas y enlace:
...
if (anuncios_particulares > 0) {
  msg <- pluralize(anuncions_particulares,
...
r <- post_tweet(status = paste0(status, collapse = ""),
           media = c("docs/last_BOE_files/figure-html/graphics-1.png",
