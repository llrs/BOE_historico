...
También cargamos los datos del BORME del 2009/01/01 (fecha a partir de la qual lo que figure en la página web tiene validez legal) hasta el 2019/12/21:
...
Segun el manual de los arxivos debería figurar el número de páginas de cada publicación pero no está. Por lo que no podemos mirar si hay alguna tendencia o un resumen. 